  ...
  return (
    <Box data-testid={TestIds.reusableDemo.page}>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
        This page demonstrates the reusable components used throughout the
        application.
      </Typography>
          ...
          <Card>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                A reusable filter form that can be configured with different
                field types.
              </Typography>
              <FilterForm
        ...
        <Grid item xs={12}>
          <Card>
            <CardContent>
              ...
              >
                <Typography variant="h6">Entity Table Component</Typography>
                <Button
                  variant="contained"
                  color="primary"
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                A reusable table component with sorting, pagination, and action
                buttons.
              </Typography>
              <EntityTable
                data={demoData}
        ...
        <Grid item xs={12}>
          <Card>
            <CardContent>
              ...
              <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                A reusable dialog for creating new items with configurable form
                fields.
              </Typography>
              <Button
                variant="outlined"
