...
export function getTierColor(tierName: string): TierColorType {
  ...
  // Admissions tiers
  if (lowerTierName.includes('admissions') || lowerTierName.includes('admission')) {
  ...
  if (lowerTierName.includes('basic') || lowerTierName.includes('standard') || lowerTierName.includes('starter')) {
